  ...
  return (
    <div className="mt-3 ml-3 mr-3 bs">
      ...
      <Tabs defaultActiveKey="1">
        ...
        <TabPane tab="parking-id" key="2">
          <Rooms />
        </TabPane>
        <TabPane tab="Add parkings" key="3">
          <Addroom />
        </TabPane>
  ...
  return (
    <div className='row'>
       <div className="col-md-5">
         ...
         value={rating} onChange={(e)=>{setmaxcount(e.target.value)}}
         />
       ...
       <div className="text-right">
         <button className='btn btn-primary mt-2' onClick={addRoom}>Add location</button>
